...
document.querySelector("#addSlugRow")
...
document.querySelector("#showAndDelSlugRow").addEventListener("click", ()=> { 
...
document.querySelector("#getGgPageSpeed").addEventListener("click", ()=>{
    run();
});